...
function VUHDO_configInitGroupsCombo()
	...
	for tIndex, tId in ipairs(VUHDO_ID_TYPE_MEMBERS[tType]) do
		...
		tInfo = VUHDO_createComboBoxInfo(VUHDO_CURRENT_GROUPS_COMBO, tName, tId, VUHDO_CURRENT_GROUP_ID);
		tInfo.func = function() VUHDO_groupSelectGroupOnSelectionChanged(this) end
